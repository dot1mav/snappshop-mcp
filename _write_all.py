"""_write_all.py — one-shot writer for the remaining project files."""
import pathlib, re, json

ROOT = pathlib.Path(r"C:\Users\dot1mav\Documents\GitHub\snappshop-mcp")
...
print("all Python files written")
